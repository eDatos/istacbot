...
indicators_check = {
    ...
    "la educacion primaria": "Alumnado no universitario. Educación primaria",
    "alumnos primaria": "Alumnado no universitario. Educación primaria",
    "los alumnos primaria": "Alumnado no universitario. Educación primaria",
...
indicators_synonyms = {
    "Presupuesto liquidado. Gastos por habitante. Ayuntamientos": ['presupuesto ayuntamiento', 'gastos municipales', 'gastos ayuntamiento'],
    "Energía electrica. Disponible": ['luz', 'energia electrica'],
    "Cabezas de ganado. Ovino": ['ovejas'],
    "Licitacion oficial en construcción": ['obras publicas', 'construccion publica'],
    "Hipotecas canceladas": ['hipotecas'],
    "Población. Edad media": ['edad media poblacion', 'edad media', 'media edad'],
    "Población. Mujeres de 65 o más años": ['viejas', 'ancianas'],
    "Accidentes de trabajo con baja": ['siniestralidad laboral', 'siniestros laborales', 'percance laboral'],
    "Población": ['habitantes', 'personas'],
    "Pernoctaciones en alojamientos turísticos": ['noches apartahoteles', 'pernoctaciones apartahoteles', 'noches hoteles', 'pernoctaciones apartamentos', 'noches apartamentos', 'pernoctaciones hoteles'],
    "Población extranjera": ['extranjeros', 'inmigracion', 'inmigrantes'],
    "Índice de precios de consumo (IPC). General": ['precios', 'ipc', 'índice precios consumo'],
    "Población. De 0 a 14 años": ['menores', 'niños', 'infancia'],
    "Visados de obra. Viviendas de obra nueva": ['licencias obra'],
    "Matriculación de vehículos": ['vehiculos matriculados', 'coches matriculados', 'matriculas coches', 'matriculas vehiculos'],
    "Alumnado no universitario. Educación primaria": ['educacion primaria'],
    "Cabezas de ganado. Caprino": ['cabras', 'cabritos'],
    "Población. Mujeres de 0 a 14 años": ['niñas'],
    "Turistas recibidos": ['veraneantes', 'turismo'],
    "Comercio exterior. Exportaciones en peso": ['exportaciones'],
    "Población ocupada": ['trabajadores', 'ocupados'],
    "Presupuesto liquidado. Ingresos fiscales por habitante. Ayuntamientos": ['impuestos ayuntamiento', 'recaudacion municipal', 'impuestos municipales', 'tributos ayuntamiento', 'tributos municipales', 'recaudacion ayuntamiento'],
    "Afiliaciones a la seguridad social": ['inscritos ss', 'altas seguridad social', 'afiliaciones ss', 'ss', 'afiliaciones', 'inscritos seguridad social', 'altas ss'],
    "Superficie cultivada": ['terreno cultivado', 'area cultivada'],
    "Cabezas de ganado. Porcino": ['cerdos', 'guarros', 'marranos', 'cochinos'],
    "Empleo registrado. Cabildos": ['empleo cabildos'],
    "Migraciones. Saldo migratorio": ['migraciones'],
    "Empresas inscritas en la Seguridad Social. Construcción": ['constructoras'],
    "Presupuesto liquidado. Gastos por habitante. Cabildos": ['gastos cabildo', 'presupuesto cabildo', 'presupuesto insular', 'gastos insulares'],
    "Tasa de empleo": ['ocupacion', 'empleo'],
    "Gasto medio por turista": ['gasto turista'],
    "Indice de producción industrial (IPI)": ['indice produccion industrial', 'ipi', 'produccion', 'produccion industrial'],
    "Plazas ofertadas por alojamientos turísticos": ['plazas ofertadas alojamientos turisticos', 'plazas hoteles', 'habitaciones hoteles', 'habitaciones alojamientos turisticos'],
    "Viajeros entrados en alojamientos turísticos": ['huespedes hoteles', 'visitantes hoteles', 'reservas hoteles', 'personas hospedadas alojamientos turisticos', 'visitantes alojamientos turisticos'],
    "Indice de ocupación (IASS). Servicios": ['puestos trabajo', 'empleo'],
    "Tasa de actividad": ['actividad'],
    "Empresas inscritas en la seguridad social": ['empresas inscritas seguridad social', 'empresas inscritas ss', 'empresas'],
    "Alumnado no universitario. Educacion infantil": ['educacion infantil'],
    "Población activa": ['activos'],
    "Indice de volumen encadenado del PIB (variaciones reales)": ['producto interior bruto', 'producto interior'],
    "Paro registrado": ['parados', 'desocupados'],
    "Población inactiva": ['estudiantes', 'jubilados', 'inactivos'],
    "Comercio exterior. Importaciones en valor": ['importaciones'],
    "Sociedades mercantiles. Creadas": ['sociedades mercantiles', 'sociedades', 'creacion empresas'],
    "IBI. Cuota liquida. Rusticos": ['ibi', 'ibi campo'],
    "Tráfico aéreo comercial. Movimiento de mercancías": ['transporte mercancías', 'tráfico aéreo comercial', 'movimiento mercancías'],
    "Presupuesto liquidado. Ingresos fiscales por habitante. Cabildos": ['tributos cabildo', 'recaudacion cabildo', 'impuestos cabildo', 'tributos insulares', 'impuestos insulares', 'recaudacion insulares'],
    "Empleo registrado. Ayuntamientos": ['empleo ayuntamientos'],
    "Licitación oficial en construcción. Edificación": ['obras públicas'],
    "Población turística equivalente en alojamientos turísticos": ['turistas'],
    "Vivienda protegida. Precio del metro cuadrado": ['precio vivienda'],
    "Indice de cifra de negocios (IASS). Servicios": ['cifra negocios'],
    "Empleo registrado": ['empleos', 'trabajo', 'empleados'],
    "Presupuesto liquidado. Ingresos por habitante. Ayuntamientos": ['ingresos ayuntamiento', 'ingresos municipales'],
    "Venta mayor de cemento": ['cemento', 'venta cemento'],
    "PIB a precios corrientes": ['pib', 'producto interno bruto'],
    "Gasto medio por turista y día": ['gasto turista dia'],
    "Alumnado no universitario. Educación secundaria obligatoria": ['eso', 'e.s.o', 'educación secundaria obligatoria'],
    "Nacimientos": ['recien nacidos', 'nacimientos', 'natalidad', 'partos'],
    "IBI. Cuota liquida. Urbanos": ['impuesto municipal', 'impuesto bienes inmuebles'],
    "Coste laboral. Por hora efectiva de trabajo": ['seguridad social', 'salarios', 'gastos labores'],
    "Población parada": ['personas desempleadas', 'paro', 'desempleados', 'personas paro'],
    "Tasa de paro": ['desempleo'],
    "Superficie": ['area', 'extension territorial', 'terreno', 'uso suelo'],
    "Licitación oficial en construcción. Ingeniería civil": ['construcción pública'],
    "Sociedades mercantiles. Amplian capital": ['capital societario'],
    "Policía local. Efectivos": ['policia'],
    "Tasa de ocupación por plazas": ['ocupacion hotelera', 'tasa ocupacion hotelera', 'ocupacion alojamientos turisticos'],
    "Empresas inscritas en la Seguridad Social. Industria": ['industrias'],
    "Indice de precios industriales (IPRI)": ['precios industriales', 'ipri'],
    "Policía Local. Efectivos por cada 1.000 habitantes": ['efectivos policía', 'policía local', 'efectivos policía habitantes'],
    "Tasa bruta de mortalidad": ['muertes', 'mortalidad'],
    "Empresas inscritas en la Seguridad Social. Agricultura": ['empresas agrarias', 'ganaderias', 'cooperativas'],
    "Parque de vehículos": ['vehiculos', 'vehiculos circulacion', 'coches circulacion', 'coches'],
    "Hipotecas constituidas": ['nuevas hipotecas', 'hipotecas firmadas'],
    "IRPF. Base imponible por declarante": ['irpf', 'impuesto renta personas fisicas', 'impuesto renta', 'renta'],
    "Cabezas de ganado. Bovino": ['toros', 'terneras', 'terneros', 'vacas'],
    "Alojamientos turisticos abiertos": ['apartamentos', 'casas rurales', 'hoteles abiertos', 'alojamientos abiertos', 'apartahotel', 'pensiones', 'hoteles'],
    "Presupuesto liquidado. Ingresos por habitante. Cabildos": ['ingresos cabildo', 'ingresos insulares'],
    "Coste laboral. Por trabajador y mes": ['cotizaciones'],
    "Matrimonios. Entre cónyuges de diferente sexo": ['parejas', 'matrimonios'],
    "Población. De 65 o más años": ['tercera edad', 'vejez', 'ancianos', 'mayores', 'viejos'],
    "Población. De 65 o más años (% sobre total)": ['Poblacion 65 años total'],
    "Población. De 0 a 14 años (% sobre total)": ['Poblacion 0 14 años total'],
}